          ...
          <div className="flex w-full">
            <div className="w-60 h-min bg-gray-50 rounded-lg border-gray-300 border">
              <ul className="relative">
                <li className="relative rounded-xl p-2">
                  <a
                    className="flex items-center text-sm py-2 px-2 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out"
                    href="#!"
            ...
            <div className=" grow w-full ml-2 mb-2">
              <div className="p-10 bg-white mb-2 rounded-lg border-gray-300 border">
                Merhaba! 👋 Henüz bir soru sormadığınızı veya bir tartışma
                başlatmadığınızı fark ettim. Bunların ikisini de yapmak
                kolaydır; Başlamak için etiket sayfasının kenar çubuğundaki 'Bir
                Yazı Yaz'ı tıklamanız yeterli! Bildirimlerinizi yönetmek için
