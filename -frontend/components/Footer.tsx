...
const Footer = () => {
    return (
        <footer className="flex flex-1 flex-col items-center justify-center w-full mt-5 bg-eksiCode dark:bg-green-900">
            ...
            <div className="w-full pb-5 pt-5  bg-eksiCodeMedium text-eksiCodeLight dark:bg-green-950">
